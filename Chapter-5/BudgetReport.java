...
public class BudgetReport {
    public static void main(String[] args)
    {
        ...
        double budget2 = 2000;      // bugeted for 2nd account
        double remaining1, remaining2;  //unspend amounts

        System.out.printf(HEADING_FMT_STR, "Account", "Actual", "Buget", "Remaining");
